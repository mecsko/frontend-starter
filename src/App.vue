...
<template>
	<div class="q-pa-md">
		<q-layout view="hHh LpR fFf">
			...
			>
				<q-toolbar>
					<q-btn dense flat icon="mdi-menu" round @click="appStore.showLeftDrawer = !appStore.showLeftDrawer" />
					<!-- <q-toolbar-title
						class="my-title"
						:shrink="true"
					...
					<q-btn dense flat icon="mdi-menu" round @click="appStore.showRightDrawer = !appStore.showRightDrawer" />
				</q-toolbar>
			</q-header>
			...
			<!-- 4. Taskbar: -->
			<q-footer v-model="appStore.showTaskBar" :class="$q.dark.isActive ? 'bg-grey-9' : 'bg-blue-5'" elevated reveal>
				<q-toolbar>
