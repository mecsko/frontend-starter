    ...
    <div class="row justify-center">
      <div class="col-12 col-sm-8 col-md-6 col-lg-4 q-gutter-y-sm">
        ...
        <q-select
          ...
          outlined
        />
        <q-input v-model="r.title" dense label="Title" outlined type="text" />
        <q-input v-model="r.description" dense label="Description" outlined type="textarea" />
        <q-input v-model="r.dateOfAd" dense label="Date of ad" outlined type="date" />
        <div class="row justify-end">
          <q-checkbox v-model="r.undamaged" dense label="Undamaged" />
        </div>
